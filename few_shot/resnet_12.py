...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_input_channels, keep_prob=1.0, avg_pool=False, drop_rate=0.0, dropblock_size=5):
        self.inplanes = num_input_channels
...
def get_few_shot_encoder(num_input_channels=3, keep_prob=1.0, avg_pool=False, **kwargs):
