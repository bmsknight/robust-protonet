...
callbacks = [
    ...
    ModelCheckpoint(
        filepath=PATH + f'/models/proto_nets/adv{args.adv_train_type}_fc_{param_str}.pth',
        monitor=f'val_{args.n_test}-shot_{args.k_test}-way_acc'
    ),
    LearningRateScheduler(schedule=lr_schedule),
    CSVLogger(PATH + f'/logs/proto_nets/adv{args.adv_train_type}_fc_{param_str}.csv'),
]
