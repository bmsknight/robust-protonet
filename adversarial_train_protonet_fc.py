...
# Model #
#########
model = get_few_shot_he_encoder(num_input_channels, final_layer_size, is_he=False, avg_pool=False, drop_rate=0.1)
...
callbacks = [
    ...
    ModelCheckpoint(
        filepath=PATH + f'/models/proto_nets/resnet_adv{args.adv_train_type}_fc_{param_str}.pth',
        monitor=f'val_{args.n_test}-shot_{args.k_test}-way_acc'
    ),
    LearningRateScheduler(schedule=lr_schedule),
    CSVLogger(PATH + f'/logs/proto_nets/resnet_adv{args.adv_train_type}_fc_{param_str}.csv'),
]
